...
public class Lv2p3DAO {
    ...
    public Boolean inserir(Lv2p3 lv2p3) {
        ...
        String sql = "INSERT INTO lv2p3(\n"
                ...
                + "torunos_quant, torunos_valor, touro_quant, touro_valor, usuario_id)\n"
                + "VALUES (\n"
                + "?, ?, ?, ?, \n"
                + "?, ?, ?, ?, \n"
                + "?, ?, ?, ?, \n"
    ...
    public Boolean atualizar(Lv2p3 lv2p3) {
        Boolean retorno = false;
        String sql = "UPDATE lv2p3\n"
                   + "SET terneiros_quant=?, terneiros_valor=?, terneiras_quant=?, \n"
                       + "terneiras_valor=?, novilhas_quant=?, novilhas_valor=?, vacas_de_descarte_quant=?, \n"
                       + "vacas_de_descarte_valor=?, vaca_prenha_quant=?, vaca_prenha_valor=?, \n"
                       + "vaca_com_cria_quant=?, vaca_com_cria_valor=?, vaca_gorda_quant=?, \n"
                       + "vaca_gorda_valor=?, novilho_pra_recria_quant=?, novilho_pra_recria_valor=?, \n"
                       + "novilho_gordo_quant=?, novilho_gordo_valor=?, torunos_quant=?, \n"
